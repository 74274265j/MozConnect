$(document).ready(function() {
    ...
    if($main_header.hasClass("home")){
        breakpoint_height = $(".main-header-home").outerHeight(true);
        console.log(breakpoint_height);
    }
...
function load_map(map_wrapper,is_homepage){
    ...
    var layer01 = L.tileLayer('../../%7bs%7d.tile.openstreetmap.org/%7bz%7d/%7bx%7d/%7by%7d.png', {
